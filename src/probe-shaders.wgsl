...
@group(1) @binding(0) var sh4Tex : texture_3d<f32>;
@group(1) @binding(1) var sh5Tex : texture_3d<f32>;
@group(1) @binding(2) var sh6Tex : texture_3d<f32>;
@group(1) @binding(3) var sh7Tex : texture_3d<f32>;
@group(1) @binding(4) var sh8Tex : texture_3d<f32>;
@group(1) @binding(5) var sh4Write : texture_storage_3d<rgba32float, write>;
@group(1) @binding(6) var sh5Write : texture_storage_3d<rgba32float, write>;
@group(1) @binding(7) var sh6Write : texture_storage_3d<rgba32float, write>;
@group(1) @binding(8) var sh7Write : texture_storage_3d<rgba32float, write>;
@group(1) @binding(9) var sh8Write : texture_storage_3d<rgba32float, write>;
